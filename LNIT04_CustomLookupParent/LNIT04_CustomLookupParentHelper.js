({
    doInit: function (component, event, helper) { 
        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                console.log("doInit_currentCase " + JSON.stringify(currentCase));
                ...
                if(currentCase.IT_Financial_Center__r != null){
                    ...
                    if(currentCase.IT_Financial_Center__r.IT_Client_Status__c != null) {
                        currentCase.IT_Financial_Center__r.newLabel = currentCase.IT_Financial_Center__r.Name +' ('+currentCase.IT_Financial_Center__r.IT_Client_Status__c+')';
                    }
    ...
    onfocus: function (component, event, helper) {
        ...
        if (component.get("v.sObject") == "Account") {
            ...
            var recordTypeId = component.get("v.RecordTypeIdCase");
            console.log('RecordTypeIdCase '+recordTypeId);
            console.log('*** '+selAccount+'*'+selCircuit);
    ...
    handleEvent: function (component, event, helper) {
        ...
        if (Object == "Account") {
            ...
            if(lookupEventToParent.hasOwnProperty('IT_Client_Status__c')) {
                lookupEventToParent.newLabel = lookupEventToParent.Name +' ('+lookupEventToParent.IT_Client_Status__c+')';
                console.log('yes');
            }
            else {
    ...
    onSubmit: function (component, event, helper) {
        ...
        console.log('finSelect*** ' +JSON.stringify(finSelect));
