({
           ...
           if (response.getState() === "SUCCESS") {
                ...
                if (caseList.cases != null && caseList.cases != '') {
                    ...
                    component.set('v.columnsWorkflow', [
                        ...
                        {label: 'Utente Edenred', fieldName: 'step_userowner', type: 'text'},
            ...
            actionWorkflow.setCallback(this, function(response) {
                if (response.getState() === "SUCCESS") {
                    ...
                    if (dataList != null && dataList.workflows != '') {
                        component.set('v.dataWorkflow', dataList.workflows.slice(0,5));
                    }else{
    ...
    openAllCases : function(component,event,helper) {
        var recordObjectId = component.get("v.recordId");
        var recordObjectName = component.get("v.sObjectName");
		var evt = $A.get("e.force:navigateToComponent");
        console.log('evt'+evt);
        evt.setParams({
            componentDef : "c:LNIT29_ViewAllCase",
            componentAttributes : {
